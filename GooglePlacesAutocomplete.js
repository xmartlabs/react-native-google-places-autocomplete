...
export default class GooglePlacesAutocomplete extends Component {
  ...
  _renderRightButton = () => {
    if (this.props.renderRightButton && this.state.text) {
      return (
        <TouchableOpacity
  ...
  _getDefaultContent = () => {
    if (this.props.renderDefaultContent) {
      return this.props.renderDefaultContent()
    }
  }
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        {this.state.dataSource.length !== 0
          ? this._getFlatList()
          : this.state.text && this.props.minLength < this.state.text.length
